...
export default function ImmocloudApp() {
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between px-5 sm:px-8 md:px-16 py-5 md:py-6 border-b border-stone-800">
      ...
      <footer className="border-t border-stone-800 px-5 sm:px-8 md:px-16 py-6 md:py-8 text-[10px] sm:text-xs font-sans uppercase tracking-widest text-stone-600">
