...
export default function ImmowebApp() {
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between px-5 sm:px-8 md:px-16 py-5 md:py-6 border-b border-stone-300 bg-white">
      ...
      <section className="px-5 sm:px-8 md:px-16 py-16 md:py-32 max-w-5xl">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-8xl leading-none tracking-tight mb-8 md:mb-10 text-stone-900 break-words">
          {t("immoweb.tagline")}
        </h1>
      ...
      <footer className="border-t border-stone-300 px-5 sm:px-8 md:px-16 py-6 md:py-8 text-[10px] sm:text-xs font-sans uppercase tracking-widest text-stone-500">
